...
class PathGeometryGenerator:
    ...
    def generatePathGeometry(self):
        ...
        with track_perf("generatePathGeometry"):
...
def _makeSTL(model, obj, ocl, model_type=None):
    ...
    with track_perf("_makeSTL"):
        ...
        if model_type == "M":
            ...
            with track_perf("_makeSTL -- MeshPart.meshFromShape"):
            ...
            with track_perf("_makeSTL -- after_meshFromShape"):
        ...
        with track_perf("_makeSTL -- ocl.STLSurf construction"):
            stl = ocl.STLSurf()
            for tri in facets:
                v1, v2, v3 = tri
                t = ocl.Triangle(
...
def pathGeomToLinesPointSet(self, obj, compGeoShp):
    ...
    """
    with track_perf("pathGeomToLinesPointSet"):
